            ...
            steps{
                script{                    
                    withAWS(credentials: '318867684519', region: 'eu-west-2') {
                        ...
                        s3Upload(pathStyleAccessEnabled: true, payloadSigningEnabled: true, file:'maven_project/target/my-app-1.0-SNAPSHOT.jar', bucket:'document-ekene', path:'ci-demo/javaapp/myapp.jar')
                    }
                }
            }
        }
